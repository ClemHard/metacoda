...
#' (3 equal mean)
#' 
#' @return the statistic of the test
#' @return quantile: the significance level
#' @return result of the test (a boolean)
#' @return case the type of test choosen (pass in argument)
#' 
#' @author Clement Hardy
#' @export
#' @import stats
