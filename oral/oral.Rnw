...
& réelles & simulées \\
\hline
réelles(pred) & \Sexpr{t_ravel_sans$all$random_forest[1,1]} & \Sexpr{t_ravel_sans$all$random_forest[1,2]} \\
\hline
simulées(pred) & \Sexpr{t_ravel_sans$all$random_forest[2,1]}   & \Sexpr{t_ravel_sans$all$random_forest[2,2]}\\
\hline
\end{tabular}};
...
& réelles & simulées \\
\hline
réelles(pred) & \Sexpr{t_ravel$all$random_forest[1,1]} & \Sexpr{t_ravel$all$random_forest[1,2]} \\
\hline
simulées(pred) & \Sexpr{t_ravel$all$random_forest[2,1]}   & \Sexpr{t_ravel$all$random_forest[2,2]} \\
\hline
\end{tabular}
\end{center}
\vspace{1cm}
...
\item Le simulateur donne de bons résultats (très variables selon les jeux de données).
\end{itemize}
