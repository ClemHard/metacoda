...
\input{../rapport/tikz_figures/otu_table}
\end{frame}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]{Ajustement profondeur de séquencage}
...
\MM{Mettre des conclusions générales et des des perspectives}
