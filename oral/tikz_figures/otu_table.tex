...
\draw[red, fill=red, opacity=0.2] (0.42-3,-0.08) circle (0.1);
\draw[red, fill=red, opacity=0.2] (0.68-3,0.43) circle (0.1);
...
\draw[green, fill=green, opacity=0.2] (-0.27-3,-0.72) circle (0.1);
\draw[green, fill=green, opacity=0.2] (-0.74-3,0.46) circle (0.1);
\draw[green, fill=green, opacity=0.2] (-0.48-3,-0.14) circle (0.1);


\draw[black, fill=black] (0.34-3,0.18) circle (0.1);
\draw[black, fill=black, opacity=0.2] (0.24-3,-0.44) circle (0.1);
