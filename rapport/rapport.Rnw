...
\end{tabular}
\end{center}
Le même phénomène que dans la classification no supervisée est observable, la classification sur les données de comptage a parfois tendance à mettre tous les échantillons dans le même groupe.\\
